...
App 1.10.0 / Engine 1.7.0 / public ABI 1.0.
...
normal/research analysis and Advanced Evidence Layer. The user-selected historical analysis range is activated before this layer runs, so chronological folds and final fitting see only that active history. Rows after the selected end round are unavailable to this layer. The random button remains
