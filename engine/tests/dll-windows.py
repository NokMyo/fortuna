...
assert api('GetEngineVersion')()==0x10700
out=(C.c_uint64*10)()
...
assert load(raw,len(raw))==0
assert set_range(1,59)==-1
assert set_range(1,60)==0
assert snapshot(s,272)==0
assert int.from_bytes(bytes(s[16:20]),'little')==60
assert int.from_bytes(bytes(s[20:24]),'little')==60
assert set_range(31,120)==0
assert snapshot(s,272)==0
assert int.from_bytes(bytes(s[16:20]),'little')==90
assert int.from_bytes(bytes(s[20:24]),'little')==120
assert set_range(0,0)==0
assert snapshot(s,272)==0
assert int.from_bytes(bytes(s[16:20]),'little')==120
